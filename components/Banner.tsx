...
import BannerAnim from "../public/truck-anim.gif";
...
function Banner() {
  return (
    <section className="w-full md:h-[50vw] lg:h-[49vw] xl:h-[49vw] xl:max-h-[55rem] pt-[90px] pb-[74.66vw] lg:pt-[122px] md:pb-0 bg-theme-1300 relative">
